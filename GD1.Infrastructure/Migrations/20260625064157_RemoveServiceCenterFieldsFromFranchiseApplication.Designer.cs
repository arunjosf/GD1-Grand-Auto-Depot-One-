...
namespace GD1.Infrastructure.Migrations
{
    ...
    [Migration("20260625064157_RemoveServiceCenterFieldsFromFranchiseApplication")]
    partial class RemoveServiceCenterFieldsFromFranchiseApplication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GD1.Domain.Entities.Agreement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GD1.Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<int>("IsAgreementSigned")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GD1.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GD1.Domain.Entities.JourneyLocation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("GD1.Domain.Entities.Payment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<decimal>("AdminCutAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("PickupChargeAmount")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("PropertyOwnerAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("GD1.Domain.Entities.VehicleCatalogItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ValidYearsCsv")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GD1.Domain.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasOne("GD1.Domain.Entities.User", "Sender")
                        .WithMany()
